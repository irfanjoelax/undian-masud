...
<body>
   ...
   <div class="container">
      <div class="card bg-white mt-5 shadow text-center">
         <div class="card-body">
            <h4 class="display-4">UNDIAN KONSUMEN</h4>
            ...
            <?php
            $no     = 1;
            $query  = "SELECT * FROM hdh_plg WHERE jmlh_hdh != 0 ORDER BY urut_hdh ASC LIMIT 1";
            ...
            <div class="modal-body text-center py-5">
               <div class="row">
                  ...
                  <div class="col-6">
                     ...
                     <h4><?= $hdh['nama_hdh'] ?></h4>
                     <h3 class="mt-2 mb-2" id="nikPemenang"></h3>
                     <h2 class="mt-5 mb-3" id="nmPemenang"></h2>
                     <hr class="bg-warning">
                  </div>
                  <div class="col-3">
   ...
   <script src="js/undian-konsumen.js"></script>
</body>
